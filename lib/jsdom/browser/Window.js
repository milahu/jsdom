...
function Window(options) {
  ...
  this.getComputedStyle = function (elt) {
    ...
    // TODO if pseudoElt, set elt = pseudoElt
    return elt._getComputedStyle();

    // TODO move code to ElementCSSInlineStyle-impl.js _getComputedStyle
    // TODO share style logic between ElementCSSInlineStyle and CSSPseudoElement
